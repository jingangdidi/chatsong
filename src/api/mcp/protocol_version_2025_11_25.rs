...
pub struct ClientCapabilitiesTasks {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub requests: Option<ClientCapabilitiesRequests>,
}

#[derive(Debug, Clone, Deserialize, Serialize)]
pub struct ClientCapabilitiesRequests {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub elicitation: Option<ClientCapabilitiesRequestsElicitation>,

    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub sampling: Option<ClientCapabilitiesRequestsSampling>,
}

#[derive(Debug, Clone, Deserialize, Serialize)]
pub struct ClientCapabilitiesRequestsElicitation {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub create: Option<Map<String, Value>>,
}

#[derive(Debug, Clone, Deserialize, Serialize)]
pub struct ClientCapabilitiesRequestsSampling {
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct ServerCapabilitiesTasksRequests {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tools: Option<ServerCapabilitiesTasksTools>,
}

#[derive(Deserialize)]
#[allow(unused)]
pub struct ServerCapabilitiesTasksTools {
    #[serde(default, skip_serializing_if = "Option::is_none")]
