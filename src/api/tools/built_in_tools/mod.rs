...
impl Group {
    pub fn to_string(&self) -> String {
        match self {
            ...
            Group::ChatLog => "chat log".to_string(),
        }
    }
...
impl BuiltInTools {
    ...
    pub fn new() -> Result<Self, MyError> {
        let tools: Vec<(Arc<dyn BuiltIn>, Group)> = vec![
            ...
            (Arc::new(EditImage::new()), Group::FileSystem),
            (Arc::new(GetFileInfo::new()), Group::FileSystem),
            (Arc::new(ImageGeneration::new()), Group::FileSystem),
            ...
            (Arc::new(LoadImage::new()), Group::FileSystem),
            (Arc::new(HeadFile::new()), Group::FileSystem),
            (Arc::new(Mermaid::new()), Group::FileSystem),
            (Arc::new(Md5Sum::new()), Group::FileSystem),
            ...
            // chat log
            (Arc::new(LoadChatLog::new()), Group::ChatLog),
        ];
